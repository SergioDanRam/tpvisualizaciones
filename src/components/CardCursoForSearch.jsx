    ...
    <>
      <div className="max-w-52 bg-secondary-light md:grid md:grid-rows-2 p-3 space-y-2 rounded-lg">
        ...
        <div className="flex flex-col">
          <div className="flex flex-col">
            <p className="font-bold text-base md:text-xl space-y-1">{name}</p>
        ...
        <Link href="/carrito" className="flex justify-center bg-primary-dark text-white rounded-md py-1">Agregar al carrito</Link>
      </div>
    </>
  );
}
