        ...
        <>
            ...
            <main className="my-12 w-11/12 mx-auto space-y-8 md:w-10/12">
                ...
                <section className="space-y-4">
                    ...
                    <div className="text-black bg-gray-400 bg-opacity-25 rounded-2xl p-4 flex justify-center space-x-2 md:justify-start">
                    ...
                    <div className="text-black bg-gray-400  bg-opacity-25 rounded-2xl p-4 flex justify-center space-x-2">
                        <div className="text-8xl text-white">
                            <FaUser />{" "}
                        </div>
                        <div className="space-y-2">
