            ...
            <div className="font-monoSans bg-background-light :bg-background- text-textPrimary-light :text-textPrimary-">
                    ...
                    <div className="w-3/4 mx-auto">
                        <div className="flex flex-col space-y-4">
                            <p className="md:text-xl lg:text-2xl">
                                La eduación es la clave que abre todas las
                                puertas. Comienza tu vieje hoy.
                            </p>
                ...
                <main className="mx-auto">
                    ...
                    <section className="my-16 mx-auto md:w-5/6">
                        <h2 className="my-8 font-semibold text-lg md:text-3xl lg:text-3xl">
                    ...
                    <div className="grid grid-rows-2 md:grid-rows-none md:grid-cols-2 bg-accent-light :bg-accent- text-textPrimary-light">
                        ...
                        <div className="w-3/4 mx-auto flex flex-col justify-center space-y-4 md:space-y-6 p-4">
                            <p className="lg:text-2xl">
                                ¡No aprendas solo! Únete al foro y descubre un
                                espacio donde tus dudas se transforman en
                                aprendizaje, y donde puedes conectar con otros
                                estudiantes y expertos dispuestos a ayudarte.
                            </p>
                            <div>
                                <Link
                                    href="/foro"
                                    className="bg-secondary-light hover:bg-secondary- font-medium p-2 rounded-md lg:text-3xl"
                                >
                                    Visita nuestro Foro
                                </Link>
                            </div>
                    ...
                    <h2 className="mx-4 my-8 lg:my-24 text-center font-semibold text-xl md:text-2xl lg:text-3xl lg:w-3/5 lg:mx-auto">
                        Da el siguiente paso y unete a la mejor comunidad para
